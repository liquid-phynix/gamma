...
void npy_save(char* fname, char* descr, int fortran_order, int stride,
              int ndims, int* shape, size_t sz, void* data);

void npy_save_double(char* fname, int fortran_order, int stride,
                     int ndims, int* shape, double* data);

void npy_save_float(char* fname, int fortran_order, int stride,
                    int ndims, int* shape, float* data);

void npy_save_int(char* fname, int fortran_order, int stride,
                  int ndims, int* shape, int* data);

void npy_save_float_complex(char* fname, int fortran_order, int stride,
                            int ndims, int* shape,
                            std::complex<float>* data);

void npy_save_double_complex(char* fname, int fortran_order, int stride,
                            int ndims, int* shape,
